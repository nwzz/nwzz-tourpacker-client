        ...
        <div className="">
            <Navbar bg="light" sticky="top" collapseOnSelect expand="lg" >
                <Container className="d-flex">
                    ...
                    <a style={{textDecoration: 'none'}} href="/"><h1><span style={{color:'tomato'}}>TourPacker</span></h1></a>
                    ...
                    {
                            user.email ?
                            <span><button onClick={logOut} className="btn" style={{backgroundColor:'tomato', color:'white'}}>Logout</button><span 
